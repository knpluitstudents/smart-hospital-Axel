...
st.markdown("""
<!-- COLOR1 -->
<div style="background:linear-gradient(135deg,hsl(215, 95%, 49%) 0%,#0a33ff 60%,#390cdd 100%);
...
with st.form("triage_form"):
    ...
    st.markdown("""
    <!-- COLOR2 -->
    <div style="background:#09d3f6;border:1px solid #09d3f6;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#0a33ff;color:white;border-radius:8px;
    ...
    st.markdown("""
    <!-- COLOR3 -->
    <div style="background:#ff0000;border:1px solid rgb(255, 93, 93);border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
    ...
    st.markdown("""
    <!-- COLOR4 -->
    <div style="background:#f6f209;border:1px solid #f6ff8e;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
    ...
    st.markdown("""
    <!-- COLOR5 -->
    <div style="background:#25f20a;border:1px solid #84ff74;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:rgb(172, 255, 161);color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">4</span>
            <span style="font-size:16px;font-weight:600;color:rgb(172, 255, 161);">Do you have any of the following?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR6 -->
    <div style="background:#9709f6;border:1px solid #c061ff;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#c061ff;color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">5</span>
            <span style="font-size:16px;font-weight:600;color:#c061ff;">Patient Information</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    submitted = st.form_submit_button("Get All Recomendation →")
